...
export default function App() {
  ...
  React.useEffect(() => {
    ...
    if (isInitialState) {
      initialTheme().then(() => setIsInitialState(false))
  ...
  return (
    <Stack.Navigator>
      ...
      >
        ...
        <Stack.Screen
          name="Iuten Player x Player"
          component={Jogo}
          initialParams={{ NPLAYERS: 2 }}
        />
        <Stack.Screen
          name="Iuten Player x PC"
          component={Jogo}
          initialParams={{ NPLAYERS: 1 }}
        />
        <Stack.Screen
          name="Iuten PC x PC"
          component={Jogo}
          initialParams={{ NPLAYERS: 0 }}
        />
      </Stack.Group>
